...
class Font:
    def __init__(self, path: str, size: int):
        ...
        self.shader = Shader(
            "shaders/fonts/text.vs",
            "shaders/fonts/text.fs"
        )
    ...
    def draw(self, text_surface, x, y, width, height):
        ...
        glUniform3f(
            ...
            text_surface.color[0],
            text_surface.color[1],
            text_surface.color[2]
        )

        glUniform1i(
            glGetUniformLocation(self.shader.program, "text"),
            0
        )
        ...
        for char in text_surface.text:
            ...
            xpos = start_x + ch.bearing[0]
            ypos = y + (ch.size[1] - ch.bearing[1])
